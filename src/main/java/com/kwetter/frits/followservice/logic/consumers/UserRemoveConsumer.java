package com.kwetter.frits.followservice.logic.consumers;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.kwetter.frits.followservice.configuration.KafkaProperties;
import com.kwetter.frits.followservice.logic.dto.UserDTO;
...
public class UserRemoveConsumer {
    ...
    public UserRemoveConsumer(KafkaProperties kafkaProperties, FollowRepository followRepository) {
            ...
            try {
                while (!closed.get()) {
                    ...
                    for (ConsumerRecord<String, String> record : records) {
                        ...
                        if (username != null) {
                            followRepository.deleteAllByUsername(username);
                            followRepository.deleteAllByFollowingUsername(username);
                        }
                    }
                }
